...
- (void)initSystemEmojiFace
{
    ...
    NSInteger cols = 8;
    if ([UIScreen mainScreen].bounds.size.width == 320) {cols = 7;}else if ([UIScreen mainScreen].bounds.size.width == 375) {cols = 8;}else if ([UIScreen mainScreen].bounds.size.width == 414){cols = 9;}
    NSInteger lines = 3;
